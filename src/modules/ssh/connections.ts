...
const STORE_PATH = "termigo-ssh-connections.json";
const STORE_KEY = "connections";

export const SSH_KEYRING_SERVICE = "termigo-ssh";
 ...
 *   handshake.
 * - `agent`: the local ssh-agent signs the handshake. Termigo never sees, stores or
...
const CHANGED_EVENT = "termigo://ssh-connections-changed";
