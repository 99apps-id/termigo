...
const PROMPT = [
  "Read this transcript and extract key persistent learnings about the PROJECT",
  "that will save time and prevent repeating mistakes in future sessions.",
  "",
  "Include:",
  "1. MISTAKES & TRAPS: Any command failure, tool error, wrong assumption, or user correction",
  "   that had to be fixed (start with '[GOTCHA]', e.g. '[GOTCHA] Always use pnpm test instead of npm test').",
  "2. CONVENTIONS & WORKFLOWS: Project commands (build, test, lint, deploy), architecture decisions,",
  "   paths that matter, tools used or refused (e.g. 'Use @/ path alias for internal imports').",
  "",
  "Exclude: transient session chatter, file contents that can be read again, and unverified assumptions.",
  "",
