...
function Hint(props: {
  ...
  return (
    <>
      <span className="justify-self-start font-medium text-foreground/80 dark:text-muted-foreground/75">
        {props.label}
      </span>
...
function Key({ children }: { children: React.ReactNode }) {
  return (
    <kbd className="inline-flex h-[22px] min-w-[22px] items-center justify-center rounded-md border border-border/80 bg-muted/60 px-1.5 font-sans text-[11px] font-semibold text-foreground shadow-2xs dark:border-border/45 dark:bg-muted/30 dark:font-medium dark:text-muted-foreground/80">
      {children}
    </kbd>
  );
}
